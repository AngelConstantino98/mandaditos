    ...
    horarios: [
  {
    ...
    productos: [
      ...
      },
      {
        ...
        opciones: [
          { id: "hamburguesa-sin-papas-gaes", nombre: "Hamburguesa sin papas", precio: 60, descripcion: "Hamburguesa sin papas." , extras: EXTRAS_HAMBURGUESAS_GAES, textoExtras: "Agrega extras para tu hamburguesa:"},
          { id: "hamburguesa-sencilla-gaes", nombre: "Hamburguesa sencilla", precio: 68, descripcion: "Incluye papas." , extras: EXTRAS_HAMBURGUESAS_GAES, textoExtras: "Agrega extras para tu hamburguesa:"},
          { id: "hamburguesa-bbq-gaes", nombre: "Hamburguesa B.B.Q.", precio: 76, descripcion: "Incluye papas." , extras: EXTRAS_HAMBURGUESAS_GAES, textoExtras: "Agrega extras para tu hamburguesa:"},
          { id: "hamburguesa-quesillo-gaes", nombre: "Hamburguesa de quesillo", precio: 76, descripcion: "Incluye papas." , extras: EXTRAS_HAMBURGUESAS_GAES, textoExtras: "Agrega extras para tu hamburguesa:"},
          { id: "hamburguesa-hawaiana-gaes", nombre: "Hamburguesa hawaiana", precio: 78, descripcion: "Incluye papas." , extras: EXTRAS_HAMBURGUESAS_GAES, textoExtras: "Agrega extras para tu hamburguesa:"},
          { id: "hamburguesa-chipotle-gaes", nombre: "Hamburguesa chipotle", precio: 76, descripcion: "Incluye papas." , extras: EXTRAS_HAMBURGUESAS_GAES, textoExtras: "Agrega extras para tu hamburguesa:"},
          { id: "hamburguesa-habanero-gaes", nombre: "Hamburguesa habanero", precio: 76, descripcion: "Incluye papas." , extras: EXTRAS_HAMBURGUESAS_GAES, textoExtras: "Agrega extras para tu hamburguesa:"},
          { id: "hamburguesa-doble-carne-gaes", nombre: "Hamburguesa doble carne", precio: 88, descripcion: "Incluye papas. 2 carnes, 2 jamón, 2 quesos amarillo, lechuga, tomate y cebolla." , extras: EXTRAS_HAMBURGUESAS_GAES, textoExtras: "Agrega extras para tu hamburguesa:"},
          { id: "hamburguesa-mango-habanero-gaes", nombre: "Hamburguesa mango habanero", precio: 88, descripcion: "Incluye papas. Carne de res, salsa de mango, aros de cebolla empanizados, jamón de pavo, queso amarillo, lechuga, tomate y cebolla." , extras: EXTRAS_HAMBURGUESAS_GAES, textoExtras: "Agrega extras para tu hamburguesa:"},
          { id: "hamburguesa-bbq-chipotle-gaes", nombre: "Hamburguesa B.B.Q. chipotle", precio: 88, descripcion: "Incluye papas. Carne de res, jamón de pavo, queso amarillo, salsas, aros de cebolla empanizados, lechuga, tomate y cebolla." , extras: EXTRAS_HAMBURGUESAS_GAES, textoExtras: "Agrega extras para tu hamburguesa:"},
          { id: "hamburguesa-gaes-especial", nombre: "Hamburguesa GAES", precio: 98, descripcion: "Incluye papas. Carne de res, jamón de pavo, queso amarillo, piña, tocino, tomate, cebolla y lechuga." , extras: EXTRAS_HAMBURGUESAS_GAES, textoExtras: "Agrega extras para tu hamburguesa:"},
        ],
      },
      {
